      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Growing with Our Clients</h3>
                  <p className="text-lg text-gray-600 leading-relaxed mb-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl p-8 border border-blue-200 text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Join the Simba Dispatch Services Family Today</h3>
              <p className="text-lg text-gray-600 leading-relaxed">
